...
const TEMPLATES = {
  ...
  react: {
    ...
    js: '// Render simple React counter component using CDN Babel compilation\nconst { useState } = React;\n\nfunction CounterApp() {\n  const [count, setCount] = useState(0);\n  return (\n    <div className="counter-app">\n      <h2>React CDN Sandbox</h2>\n      <p>This template compiles React on the fly via Babel CDN!</p>\n      <div style={{ fontSize: "3rem", fontWeight: "bold", margin: "1.5rem 0", color: "#60a5fa" }}>\n        {count}\n      </div>\n      <button className="btn" onClick={() => setCount(count + 1)}>\n        Increment Count\n      </button>\n    </div>\n  );\n}\n\nconst root = ReactDOM.createRoot(document.getElementById("root"));\nroot.render(<CounterApp />);'
  }
};
          ...
          <div className="p-3 border-t border-slate-800 shrink-0">
            ...
            <div className="space-y-2">
              ...
              <button 
                ...
                className="w-full text-left p-2.5 rounded-xl border border-slate-850 hover:border-slate-700 bg-slate-900/40 hover:bg-slate-900 transition-all"
              >
                <div className="text-xs font-bold text-slate-200">React CDN App</div>
