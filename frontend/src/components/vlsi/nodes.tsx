...
export const vlsiNodeTypes: Record<string, React.ComponentType<any>> = {
  ...
  ram_16x4:     MemoryNode,
  rom_16x4:     MemoryNode,
  fifo_16x4:    MemoryNode,
  display_7seg: Display7SegNode,
  clk_div_2:    TimingNode,
  clk_div_4:    TimingNode,
  pulse_gen:    TimingNode,
  watchdog_timer: TimingNode,
  frequency_counter: TimingNode,
  uart_tx_8bit: CommunicationNode,
  spi_master:   CommunicationNode,
  i2c_master:   CommunicationNode,
  i2c_slave:    CommunicationNode,
  piso_8bit:    CommunicationNode,
  sipo_8bit:    CommunicationNode,
  pwm_gen:      InterfaceNode,
  debounce:     InterfaceNode,
  keypad_encoder: InterfaceNode,
  stepper_motor_logic: InterfaceNode,
  traffic_light_ctrl: InterfaceNode,
  vending_machine_logic: InterfaceNode,
  full_subtractor: ArithmeticNode,
  mag_comparator_8bit: ArithmeticNode,
  bcd_adder:    ArithmeticNode,
  johnson_counter_4bit: SequentialAdvNode,
  ring_counter_4bit: SequentialAdvNode,
};
