...
const SIMULATOR_BOARDS: Record<string, { id: string; label: string; url: string; openLabel?: string }[]> = {
  ...
  analog: [
    ...
    { id: 'ae-rc', label: 'RC Filter', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=filt-lopass.txt', openLabel: 'Open in CircuitJS' },
    { id: 'ae-bjt', label: 'BJT Amp', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=ceamp.txt', openLabel: 'Open in CircuitJS' },
    { id: 'ae-mosfet', label: 'MOSFET', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=nmosfet.txt', openLabel: 'Open in CircuitJS' },
  ...
  digital: [
    ...
    { id: 'de-gates', label: 'Logic Gates', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=xor.txt', openLabel: 'Open in CircuitJS' },
