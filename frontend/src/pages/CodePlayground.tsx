...
const SIMULATOR_BOARDS: Record<string, { id: string; label: string; url: string; openLabel?: string; noEmbed?: boolean; octaveUrl?: string }[]> = {
  ...
  analog: [
    ...
    { id: 'ae-bjt', label: 'CE Amplifier', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=ceamp.txt', openLabel: 'Open in CircuitJS' },
    { id: 'ae-mosfet', label: 'n-MOSFET', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=nmosfet.txt', openLabel: 'Open in CircuitJS' },
    { id: 'ae-diode', label: 'Diode', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=diodevar.txt', openLabel: 'Open in CircuitJS' },
    { id: 'ae-555', label: '555 Timer', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=555square.txt', openLabel: 'Open in CircuitJS' },
  ],
  digital: [
    ...
    { id: 'de-gates', label: 'XOR Gate', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=xor.txt', openLabel: 'Open in CircuitJS' },
    { id: 'de-flipflop', label: 'SR Flip-Flop', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=nandff.txt', openLabel: 'Open in CircuitJS' },
    { id: 'de-dff', label: 'D Flip-Flop', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=edgedff.txt', openLabel: 'Open in CircuitJS' },
    { id: 'de-counter', label: '4-Bit Counter', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=counter.txt', openLabel: 'Open in CircuitJS' },
    { id: 'de-decoder', label: '7-Seg Decoder', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=7segdecoder.txt', openLabel: 'Open in CircuitJS' },
...
const EEE_SIMULATOR_BOARDS: Record<string, { id: string; label: string; url: string; openLabel?: string; externalUrl?: string; externalLabel?: string; noEmbed?: boolean; octaveUrl?: string }[]> = {
  power_electronics: [
    ...
    { id: 'pe-fullrect', label: 'Full-Wave Rectifier', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=fullrect.txt', openLabel: 'Open in CircuitJS' },
    { id: 'pe-fullrectf', label: 'Rectifier w/ Filter', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=fullrectf.txt', openLabel: 'Open in CircuitJS' },
    { id: 'pe-voltdouble', label: 'Voltage Doubler', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=voltdouble.txt', openLabel: 'Open in CircuitJS' },
    { id: 'pe-555pwm', label: '555 PWM', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=555pulsemod.txt', openLabel: 'Open in CircuitJS' },
  ...
  control_systems: [
    ...
    { id: 'cs-schmitt', label: 'Schmitt Trigger', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=amp-schmitt.txt', openLabel: 'Open in CircuitJS' },
  ],
  electrical_machines: [
    ...
    { id: 'em-stepup', label: 'Step-Up Transformer', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=transformerup.txt', openLabel: 'Open in CircuitJS' },
    { id: 'em-stepdown', label: 'Step-Down Transformer', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=transformerdown.txt', openLabel: 'Open in CircuitJS' },
  ...
  power_systems: [
    ...
    { id: 'ps-tlstand', label: 'Standing Wave (T-Line)', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=tlstand.txt', openLabel: 'Open in CircuitJS' },
    { id: 'ps-powerfactor', label: 'Power Factor', url: 'https://www.falstad.com/circuit/circuitjs.html?startCircuit=powerfactor1.txt', openLabel: 'Open in CircuitJS' },
  ],
