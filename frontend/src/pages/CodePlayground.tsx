...
module tb;
  ...
  pcb: [
    { id: 'pcb-flux', label: 'Flux.ai Editor', url: 'https://www.flux.ai/p', openLabel: 'Open Flux.ai', externalUrl: 'https://easyeda.com/editor', externalLabel: 'Open EasyEDA Editor' },
