...
const SIMULATOR_BOARDS: Record<string, { id: string; label: string; url: string; openLabel?: string }[]> = {
  ...
  analog: [
    ...
    { id: 'ae-opamp', label: 'Op-Amp', url: 'https://www.falstad.com/circuit/e-opamp.html', openLabel: 'Open in CircuitJS' },
    { id: 'ae-rc', label: 'RC Low-Pass Filter', url: 'https://www.falstad.com/circuit/e-filt-lopass.html', openLabel: 'Open in CircuitJS' },
    { id: 'ae-bjt', label: 'CE Amplifier', url: 'https://www.falstad.com/circuit/e-ceamp.html', openLabel: 'Open in CircuitJS' },
    { id: 'ae-mosfet', label: 'n-MOSFET', url: 'https://www.falstad.com/circuit/e-nmosfet.html', openLabel: 'Open in CircuitJS' },
    { id: 'ae-diode', label: 'Diode', url: 'https://www.falstad.com/circuit/e-diodevar.html', openLabel: 'Open in CircuitJS' },
    { id: 'ae-555', label: '555 Timer', url: 'https://www.falstad.com/circuit/e-555square.html', openLabel: 'Open in CircuitJS' },
  ],
  digital: [
    { id: 'de-blank', label: 'Blank Circuit', url: 'https://www.falstad.com/circuit/circuitjs.html?ctz=CQAgjCAMB0l3BWcA2aAOMB2ALGXyEBOAbmAmwmwFMBaMMAKACcQUFDxCRsKBmEbqh7ce-YUJR1BkEJByYAHiGC4ALpzV8hOvYb37MBg5QCMvIbsPG6Zjlx5A', openLabel: 'Open in CircuitJS' },
    { id: 'de-gates', label: 'XOR Gate', url: 'https://www.falstad.com/circuit/e-xor.html', openLabel: 'Open in CircuitJS' },
    { id: 'de-flipflop', label: 'SR Flip-Flop', url: 'https://www.falstad.com/circuit/e-nandff.html', openLabel: 'Open in CircuitJS' },
    { id: 'de-dff', label: 'D Flip-Flop', url: 'https://www.falstad.com/circuit/e-edgedff.html', openLabel: 'Open in CircuitJS' },
    { id: 'de-counter', label: '4-Bit Counter', url: 'https://www.falstad.com/circuit/e-counter.html', openLabel: 'Open in CircuitJS' },
    { id: 'de-decoder', label: '7-Seg Decoder', url: 'https://www.falstad.com/circuit/e-7segdecoder.html', openLabel: 'Open in CircuitJS' },
    { id: 'de-fulladd', label: 'Full Adder', url: 'https://www.falstad.com/circuit/e-fulladd.html', openLabel: 'Open in CircuitJS' },
  ],
  vlsi: [
  ...
  communication: [
    ...
    { id: 'comm-am', label: 'AM Detector', url: 'https://www.falstad.com/circuit/e-amdetect.html', openLabel: 'Open in CircuitJS' },
    { id: 'comm-vco', label: 'VCO (FM Basis)', url: 'https://www.falstad.com/circuit/e-vco.html', openLabel: 'Open in CircuitJS' },
    { id: 'comm-phaseshiftosc', label: 'Phase-Shift Oscillator', url: 'https://www.falstad.com/circuit/e-phaseshiftosc.html', openLabel: 'Open in CircuitJS' },
...
const EEE_SIMULATOR_BOARDS: Record<string, { id: string; label: string; url: string; openLabel?: string; externalUrl?: string; externalLabel?: string }[]> = {
  power_electronics: [
    ...
    { id: 'pe-halfwave', label: 'Half-Wave Rectifier', url: 'https://www.falstad.com/circuit/e-rectify.html', openLabel: 'Open in CircuitJS' },
    { id: 'pe-fullrect', label: 'Full-Wave Rectifier', url: 'https://www.falstad.com/circuit/e-fullrect.html', openLabel: 'Open in CircuitJS' },
    { id: 'pe-fullrectf', label: 'Rectifier w/ Filter', url: 'https://www.falstad.com/circuit/e-fullrectf.html', openLabel: 'Open in CircuitJS' },
    { id: 'pe-voltdouble', label: 'Voltage Doubler', url: 'https://www.falstad.com/circuit/e-voltdouble.html', openLabel: 'Open in CircuitJS' },
    { id: 'pe-555pwm', label: '555 PWM', url: 'https://www.falstad.com/circuit/e-555pulsemod.html', openLabel: 'Open in CircuitJS' },
    { id: 'pe-schmitt', label: 'Schmitt Trigger', url: 'https://www.falstad.com/circuit/e-amp-schmitt.html', openLabel: 'Open in CircuitJS' },
  ],
  control_systems: [
    { id: 'cs-octave', label: 'GNU Octave Online', url: 'https://octave-online.net/', openLabel: 'Open Octave' },
    { id: 'cs-opamp', label: 'Op-Amp', url: 'https://www.falstad.com/circuit/e-opamp.html', openLabel: 'Open in CircuitJS' },
    { id: 'cs-integrator', label: 'Integrator', url: 'https://www.falstad.com/circuit/e-amp-integ.html', openLabel: 'Open in CircuitJS' },
    { id: 'cs-differentiator', label: 'Differentiator', url: 'https://www.falstad.com/circuit/e-amp-dfdx.html', openLabel: 'Open in CircuitJS' },
    { id: 'cs-schmitt', label: 'Schmitt Trigger', url: 'https://www.falstad.com/circuit/e-amp-schmitt.html', openLabel: 'Open in CircuitJS' },
  ],
  electrical_machines: [
    { id: 'em-transformer', label: 'Transformer', url: 'https://www.falstad.com/circuit/e-transformer.html', openLabel: 'Open in CircuitJS' },
    { id: 'em-stepup', label: 'Step-Up Transformer', url: 'https://www.falstad.com/circuit/e-transformerup.html', openLabel: 'Open in CircuitJS' },
    { id: 'em-stepdown', label: 'Step-Down Transformer', url: 'https://www.falstad.com/circuit/e-transformerdown.html', openLabel: 'Open in CircuitJS' },
    { id: 'em-inductive', label: 'Inductive Kickback', url: 'https://www.falstad.com/circuit/e-inductkick.html', openLabel: 'Open in CircuitJS' },
    { id: 'em-powerfactor', label: 'Power Factor', url: 'https://www.falstad.com/circuit/e-powerfactor1.html', openLabel: 'Open in CircuitJS' },
    { id: 'em-pfc', label: 'Power Factor Correction', url: 'https://www.falstad.com/circuit/e-powerfactor2.html', openLabel: 'Open in CircuitJS' },
  ...
  power_systems: [
    ...
    { id: 'ps-phaseseq', label: 'Phase-Sequence Network', url: 'https://www.falstad.com/circuit/e-phaseseq.html', openLabel: 'Open in CircuitJS' },
    { id: 'ps-longdist', label: 'Long Distance Transmission', url: 'https://www.falstad.com/circuit/e-longdist.html', openLabel: 'Open in CircuitJS' },
    { id: 'ps-tl', label: 'Transmission Line', url: 'https://www.falstad.com/circuit/e-tl.html', openLabel: 'Open in CircuitJS' },
    { id: 'ps-tlstand', label: 'Standing Wave (T-Line)', url: 'https://www.falstad.com/circuit/e-tlstand.html', openLabel: 'Open in CircuitJS' },
    { id: 'ps-powerfactor', label: 'Power Factor', url: 'https://www.falstad.com/circuit/e-powerfactor1.html', openLabel: 'Open in CircuitJS' },
  ],
  ...
  measurements: [
    { id: 'mi-wheatstone', label: 'Wheatstone Bridge', url: 'https://www.falstad.com/circuit/e-wheatstone.html', openLabel: 'Open in CircuitJS' },
    { id: 'mi-voltdivide', label: 'Voltage Divider', url: 'https://www.falstad.com/circuit/e-voltdivide.html', openLabel: 'Open in CircuitJS' },
    { id: 'mi-thevenin', label: 'Thevenin Theorem', url: 'https://www.falstad.com/circuit/e-thevenin.html', openLabel: 'Open in CircuitJS' },
    { id: 'mi-norton', label: 'Norton Theorem', url: 'https://www.falstad.com/circuit/e-norton.html', openLabel: 'Open in CircuitJS' },
    { id: 'mi-octave', label: 'GNU Octave (Analysis)', url: 'https://octave-online.net/', openLabel: 'Open Octave' },
  ],
  renewable_energy: [
    { id: 're-diode', label: 'Solar Cell (Diode)', url: 'https://www.falstad.com/circuit/e-diodevar.html', openLabel: 'Open in CircuitJS' },
    { id: 're-fullrect', label: 'Full-Wave Rectifier', url: 'https://www.falstad.com/circuit/e-fullrect.html', openLabel: 'Open in CircuitJS' },
    { id: 're-voltdouble', label: 'Voltage Doubler', url: 'https://www.falstad.com/circuit/e-voltdouble.html', openLabel: 'Open in CircuitJS' },
...
const CIVIL_SIMULATOR_BOARDS: Record<string, { id: string; label: string; url: string; openLabel?: string; externalUrl?: string; externalLabel?: string }[]> = {
  ...
  fluid_mechanics: [
    ...
    { id: 'fm-rlc', label: 'RLC Circuit (Pipe Analogy)', url: 'https://www.falstad.com/circuit/e-lrc.html', openLabel: 'Open in CircuitJS' },
  ],
  surveying: [
