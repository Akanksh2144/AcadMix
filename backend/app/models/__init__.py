...
from app.models.evaluation import Quiz, Question, Option, QuizAttempt, QuizAnswer, ProctoringEvent, ProctoringViolation, Appeal, MarkSubmission, MarkSubmissionEntry, SemesterGrade, StudentRanking, CIATemplate, CIATemplateComponent, SubjectCIAConfig, ExamSchedule, QuestionPaperSubmission, TeachingEvaluation, StudyMaterial, CodingChallenge, ChallengeProgress
